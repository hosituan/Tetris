...
namespace xephinh1
{
    public class clsCot : clsDrawObject
    {
        public override void Draw(Graphics gp, Brush myBrush, Pen myPen)
        {
            ...
            gp.FillRectangle(myBrush, pos.X, pos.Y + 90, 30, 30);
            ...
            gp.DrawRectangle(myPen, pos.X, pos.Y + 90, 30, 30);
        }
